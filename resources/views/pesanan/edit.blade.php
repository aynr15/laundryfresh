      ...
      <div class="section-title">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="{{route ('pesanan.update', ['pesanan' => $pesanans->pesanan_id]) }}" method="post" role="form" class="php-email-form">
              @csrf
              @method('PUT')
              <div class="row">
              ...
              <div class="form-group mt-3">
                  ...
                  <option value="{{ $layanan->id }}" {{ $pesanans->layanan_id == $layanan->id ? 'selected' : '' }}>{{ $layanan->code.' - 
